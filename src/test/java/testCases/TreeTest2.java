...
public class TreeTest2 extends BaseClass{
	...
	@Parameters("Browser") 
	@BeforeClass
	public void openinglink(String Browser)
	{
		launchApp(Browser);
	 ...
	 * @Description("Tree Page Test")
	 * 
	 * @Story("Story Name: typesOfTreesPage check") public void typesOfTreesPage() {
	 * Log.startTestCase("typesOfTreesPage");
	 * 
	 * Log.info("clicking on Types of Linkelist link in LinkedList page");
	 * treeObj.clickTypesOfTrees();; String actUrl = treeObj.currUrl(); String
	 * expUrl = "https://dsportalapp.herokuapp.com/tree/types-of-trees/";
	 * Log.info("checking the Types of Trees page url....");
	 * Assert.assertEquals(actUrl,expUrl);
	 * 
	 * treeObj.clickTryhere(); String actTitle = treeObj.gettitle(); String expTitle
	 * = "Assessment";
	 * Log.info("checking the try Editor page in Types of Linked List page....");
	 * Assert.assertEquals(actTitle,expTitle);
	 * 
	 * treeObj.enterPyCode(); treeObj.clickRun(); String actOutput =
	 * treeObj.getOutput(); String ExpOutput = "10"; Log.info("verifying output");
	 * Assert.assertEquals(actOutput,ExpOutput);
	 ...
	 * @Description("Tree Page Test")
	 * 
	 * @Story("Story Name: treeTraversalsPage check") public void
	 * treeTraversalsPage() { Log.startTestCase("treeTraversalsPage");
	 * 
	 * Log.info("clicking on treeTraversalsPage link in tree page");
	 * treeObj.clickTreeTraversals(); String actUrl = treeObj.currUrl(); String
	 * expUrl = "https://dsportalapp.herokuapp.com/tree/tree-traversals/";
	 * Log.info("checking the introduction page url....");
	 * Assert.assertEquals(actUrl,expUrl);
	 * 
	 * treeObj.clickTryhere(); String actTitle = treeObj.gettitle(); String expTitle
	 ...
	 * Log.info("checking run button in try Editor page ");
	 * if(treeObj.isRundisplayed()) {
	 * Log.info("Run button displayed in try editor page"); } else {
	 * Log.info("Run button NOT displayed in try editor page"); }
	 ...
	 * @Description("Tree Page Test")
	 * 
	 * @Story("Story Name: travIllustartionPage check") public void
	 * travIllustartionPage() { Log.startTestCase("travIllustartionPage");
	 * 
	 * Log.info("clicking on travIllustartion link in tree page");
	 * treeObj.clickTravIllustartion(); String actUrl = treeObj.currUrl(); String
	 * expUrl = "https://dsportalapp.herokuapp.com/tree/traversals-illustration/";
	 ...
	 * @Description("Tree Page Test")
	 * 
	 * @Story("Story Name: binaryTreesPage check") public void binaryTreesPage() {
	 * Log.startTestCase("binaryTreesPage");
	 * 
	 * Log.info("clicking on binaryTrees Page link in tree page");
	 * treeObj.clickBinaryTrees(); String actUrl = treeObj.currUrl(); String expUrl
	 * = "https://dsportalapp.herokuapp.com/tree/binary-trees/";
	 ...
	 * @Description("Tree Page Test")
	 * 
	 * @Story("Story Name: pracQuestionsPage check") public void pracQuestionsPage()
	 * { Log.startTestCase("pracQuestionsPage"); treeObj.clickBinaryTrees();
	 * treeObj.clickPracQuestions(); String actUrl = treeObj.currUrl(); String
	 * expUrl = "https://dsportalapp.herokuapp.com/tree/practice";
	 * Log.info("checking the pracQuestions page url....");
	 * Assert.assertEquals(actUrl,expUrl); Log.endTestCase("pracQuestionsPage"); }
	 */
}
